...
class EnhancedTable(QTableWidget):
    ...
    def setup_table(self):
        ...
        # Set table header style to normal (non-bold)
        ...
        self.verticalHeader().setDefaultSectionSize(30)  # (Adjust 30 to desired row height)
...
class SoilProfileApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Left Panel Setup (Borehole Information, Import CSV, and Borehole Data)
        left_panel = QWidget()
        ...
        # Make only the title bold using stylesheet (child widgets will not inherit bold)
        ...
        # Borehole Data Section (Both tables shown vertically)
        ...
        # Right Panel Setup (Plot Area and Plot Settings below the plot)
        right_panel = QWidget()
        ...
        # Plot Settings Section (Below the plot)
        ...
        cp_layout.setSpacing(10)  # Adjust spacing between elements in this section
        ...
        # Adjust padding of grid settings section if desired:
        grid_group.setContentsMargins(10, 10, 10, 10)  # Modify these values as needed.
